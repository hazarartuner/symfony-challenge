...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        $this->services['assetic.filter.jpegoptim'] = $instance = new \Assetic\Filter\JpegoptimFilter('/usr/bin/jpegoptim');
    ...
    {
        return $this->services['assetic.filter_manager'] = new \Symfony\Bundle\AsseticBundle\FilterManager($this, array('cssrewrite' => 'assetic.filter.cssrewrite', 'jpegoptim' => 'assetic.filter.jpegoptim', 'closure' => 'assetic.filter.closure.jar', 'yui_css' => 'assetic.filter.yui_css', 'scssphp' => 'assetic.filter.scssphp'));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'technical_tests_sfy_2', 'user' => 'technical_tests_sfy', 'password' => 'fU3sy0Lze5IO', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_80fbacf42f5cb0228256225611cdd0ec71ad95e89456d687edd4ca91ed509315');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('a899a352f8062efe3b9b302f43c69e0245af2343');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5ce8371895e157.62765886')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'database_port' => NULL,
            'database_name' => 'technical_tests_sfy_2',
            'database_user' => 'technical_tests_sfy',
            'database_password' => 'fU3sy0Lze5IO',
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'secret' => 'a899a352f8062efe3b9b302f43c69e0245af2343',
            'google_api_key' => 'TODO',
            'app_locales' => array(
                0 => 'fr_FR',
            ),
            'currency' => 'EUR',
            'technicalemail' => 'dev@cobbleweb.co.uk',
            'cdn_domain' => 'http://test-project.dev',
            'mandril_sender_name' => 'dev@cobbleweb.co.uk',
            'locale' => 'en',
            ...
            'kernel.secret' => 'a899a352f8062efe3b9b302f43c69e0245af2343',
            ...
            'assetic.node.bin' => '/Users/vngrs/.nvm/versions/node/v11.9.0/bin/node',
            'assetic.ruby.bin' => '/usr/bin/ruby',
            'assetic.sass.bin' => '/usr/bin/sass',
            'assetic.reactjsx.bin' => '/usr/bin/jsx',
            'assetic.filter.cssrewrite.class' => 'Assetic\\Filter\\CssRewriteFilter',
            'assetic.filter.jpegoptim.class' => 'Assetic\\Filter\\JpegoptimFilter',
            'assetic.filter.jpegoptim.bin' => '/usr/bin/jpegoptim',
